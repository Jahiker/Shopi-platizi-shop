  ...
  return (
    ...
    >
      ...
      {context.cartProducts?.length > 0
        ? (
          <div className='flex flex-col gap-1 mt-10 overflow-y-scroll scrollbar-thin h-[53vh]'>
        ...
        : (
          <div className='flex flex-col items-center justify-center gap-4 mt-10 overflow-y-scroll scrollbar-thin h-[53vh]'>
