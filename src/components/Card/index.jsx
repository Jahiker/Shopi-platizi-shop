  ...
  return (
    <div className='w-full bg-white rounded-md shadow-md cursor-pointer h-60'>
      <figure className='relative w-full mb-2 h-4/5'>
        <span className='absolute bottom-0 left-0 px-2 py-[2px] text-xs text-black rounded-xl bg-white/60 m-2 '>{product.category.name}</span>
        <img src={product.images[0]} alt={product.title} className='object-cover object-center w-full h-full rounded-lg' />
